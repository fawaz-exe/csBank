...
const registerCustomer = async (req, res) => {
    try {
        ...
        // Create user only (no customer yet)
        ...
        await sendEmail({
            ...
            body: `
                Hello,<br>
                Please click this <a href="http://localhost:6040/api/auth/verify/email/${emailtoken}">link</a> to verify your email.
                <br>
                Thank you.
            `
        });
        ...
        await sendSMS({
            to: user.phone,
            body: `Hello, Please click this link to verify your phone number: http://localhost:6040/api/auth/verify/phone/${phoneOtp}
Thank you.`
        });

        console.log("User registered successfully. Please verify email & phone.");
